...
Source: https://proofwiki.org/wiki/Primitive_of_Root_of_x_squared_minus_a_squared_cubed_over_x_squared
...
\(\ds \frac {-\paren {\sqrt {x^2 - a^2} }^3} x - \frac {3 x \sqrt {x^2 - a^2} } 2 - \frac {3 a^2} 2 \ln \size {x + \sqrt {x^2 - a^2} } + C\)
