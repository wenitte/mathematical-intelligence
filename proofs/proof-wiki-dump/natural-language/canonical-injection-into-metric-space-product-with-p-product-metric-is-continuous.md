...
Source: https://proofwiki.org/wiki/Canonical_Injection_into_Metric_Space_Product_with_P-Product_Metric_is_Continuous
...
Sources
1975: W.A. Sutherland: Introduction to Metric and Topological Spaces ... (previous) ... (next): $2$: Continuity generalized: metric spaces: Exercise $2.6: 16$
