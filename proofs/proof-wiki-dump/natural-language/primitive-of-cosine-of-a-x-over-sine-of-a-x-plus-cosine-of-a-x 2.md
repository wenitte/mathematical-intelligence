...
Source: https://proofwiki.org/wiki/Primitive_of_Cosine_of_a_x_over_Sine_of_a_x_plus_Cosine_of_a_x
...
\(\ds \int \frac {\paren {\sin a x + \cos a x - \sin a x} \rd x} {\sin a x + \cos a x}\)
