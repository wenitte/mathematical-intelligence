...
Source: https://proofwiki.org/wiki/Schanuel%27s_Conjecture_Implies_Transcendence_of_Pi_by_Euler%27s_Number


This article needs to be linked to other articles.In particular: non-trivial polynomialYou can help $\mathsf{Pr} \infty \mathsf{fWiki}$ by adding these links.To discuss this page in more detail, feel free to use the talk page.When this work has been completed, you may remove this instance of {{MissingLinks}} from the code.
Theorem
