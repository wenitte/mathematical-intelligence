...
Source: https://proofwiki.org/wiki/Derivative_of_General_Logarithm_Function/Proof
...
Sources
1953: L. Harwood Clarke: A Note Book in Pure Mathematics ... (previous) ... (next): $\text {II}$. Calculus: Differentiation: Log to base $a$
