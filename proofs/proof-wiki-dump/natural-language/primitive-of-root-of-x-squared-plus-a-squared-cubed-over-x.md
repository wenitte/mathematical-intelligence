...
Source: https://proofwiki.org/wiki/Primitive_of_Root_of_x_squared_plus_a_squared_cubed_over_x
...
\(\ds \frac {\paren {\sqrt {x^2 + a^2} }^3} 3 + a^2 \sqrt {x^2 + a^2} - a^3 \map \ln {\frac {a + \sqrt {x^2 + a^2} } x} + C\)
...
Sources
1968: Murray R. Spiegel: Mathematical Handbook of Formulas and Tables ... (previous) ... (next): $\S 14$: Integrals involving $\sqrt {x^2 + a^2}$: $14.207$
