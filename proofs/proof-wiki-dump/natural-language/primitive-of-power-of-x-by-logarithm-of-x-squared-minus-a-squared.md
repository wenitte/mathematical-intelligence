...
Source: https://proofwiki.org/wiki/Primitive_of_Power_of_x_by_Logarithm_of_x_squared_minus_a_squared
...
\(\ds \frac {x^{m + 1} \map \ln {x^2 - a^2} } {m + 1} - \frac 2 {m + 1} \int \frac {x^{m + 2} } {x^2 - a^2} \rd x\)
