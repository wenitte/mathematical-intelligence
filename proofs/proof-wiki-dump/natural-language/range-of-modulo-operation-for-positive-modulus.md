...
Source: https://proofwiki.org/wiki/Range_of_Modulo_Operation_for_Positive_Modulus
...
Sources
1997: Donald E. Knuth: The Art of Computer Programming: Volume 1: Fundamental Algorithms (3rd ed.) ... (previous) ... (next): $\S 1.2.4$: Integer Functions and Elementary Number Theory: $(2) \ \text{a)}$
