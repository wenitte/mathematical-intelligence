...
Source: https://proofwiki.org/wiki/Primitive_of_Reciprocal_of_x_cubed_by_Root_of_x_squared_plus_a_squared_cubed
...
\(\ds \frac 1 {a^2} \paren {\frac {- \sqrt {x^2 + a^2} } {2 a^2 x^2} + \frac 1 {2 a^3} \map \ln {\frac {a + \sqrt {x^2 + a^2} } x} } - \frac 1 {a^2} \int \frac {\d x} {x \paren {\sqrt {x^2 + a^2} }^3} + C\)
...
\(\ds \frac 1 {a^2} \paren {\frac {- \sqrt {x^2 + a^2} } {2 a^2 x^2} + \frac 1 {2 a^3} \map \ln {\frac {a + \sqrt {x^2 + a^2} } x} }\)
...
\(\ds \frac 1 {a^2} \paren {\frac 1 {a^2 \sqrt {x^2 + a^2} } - \frac 1 {a^3} \map \ln {\frac {a + \sqrt {x^2 + a^2} } x} } + C\)
...
\(\ds \frac {-1} {2 a^2 x^2 \sqrt {x^2 + a^2} } - \frac 3 {2 a^4 \sqrt {x^2 + a^2} } + \frac 3 {2 a^5} \map \ln {\frac {a + \sqrt {x^2 + a^2} } x} + C\)
...
Sources
1968: Murray R. Spiegel: Mathematical Handbook of Formulas and Tables ... (previous) ... (next): $\S 14$: Integrals involving $\sqrt {x^2 + a^2}$: $14.202$
