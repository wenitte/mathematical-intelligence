...
Source: https://proofwiki.org/wiki/Primitive_of_Root_of_x_squared_minus_a_squared_over_x_squared/Logarithm_Form



Theorem
$\ds \int \frac {\sqrt {x^2 - a^2} } {x^2} \rd x = \frac {-\sqrt {x^2 - a^2} } x + \ln \size {x + \sqrt {x^2 - a^2} } + C$
for $x^2 \ge a^2$.
...
\(\ds \frac {-\sqrt {x^2 - a^2} } x + \ln \size {x + \sqrt {x^2 - a^2} } + C\)
...
Sources
1968: Murray R. Spiegel: Mathematical Handbook of Formulas and Tables ... (previous) ... (next): $\S 14$: Integrals involving $\sqrt {x^2 - a^2}$: $14.221$
