...
Source: https://proofwiki.org/wiki/Primitive_of_Sine_of_a_x_over_Sine_of_a_x_plus_Cosine_of_a_x
...
\(\ds \int \d x - \int \frac {\cos a x \rd x} {\sin a x + \cos a x}\)
...
\(\ds \int \d x - \int \frac {\paren {\cos a x - \sin a x + \sin a x} \rd x} {\sin a x + \cos a x}\)
...
\(\ds \int \d x - \int \frac {\paren {\cos a x - \sin a x} \rd x} {\sin a x + \cos a x} - \int \frac {\sin a x \rd x} {\sin a x + \cos a x}\)
...
\(\ds \int \d x - \int \frac {\paren {\cos a x - \sin a x} \rd x} {\sin a x + \cos a x}\)
...
\(\ds \frac 1 2 \int \d x - \frac 1 {2 a} \int \frac {a \paren {\cos a x - \sin a x} \rd x} {\sin a x + \cos a x}\)
