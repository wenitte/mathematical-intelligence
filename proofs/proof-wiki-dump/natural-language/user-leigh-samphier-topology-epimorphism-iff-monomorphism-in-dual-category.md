...
Source: https://proofwiki.org/wiki/User:Leigh.Samphier/Topology/Epimorphism_iff_Monomorphism_in_Dual_Category
...
Then $f$ is a epimorphism in $\mathbf C$ if and only if $f^{\operatorname{op}}$ is a monomorphism in $\mathbf C^{\operatorname{op}}$.
