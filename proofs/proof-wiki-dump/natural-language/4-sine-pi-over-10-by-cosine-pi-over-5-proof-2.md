...
Source: https://proofwiki.org/wiki/4_Sine_Pi_over_10_by_Cosine_Pi_over_5/Proof_2
...
This article needs to be linked to other articles.In particular: I started but it's tediousYou can help $\mathsf{Pr} \infty \mathsf{fWiki}$ by adding these links.To discuss this page in more detail, feel free to use the talk page.When this work has been completed, you may remove this instance of {{MissingLinks}} from the code.
