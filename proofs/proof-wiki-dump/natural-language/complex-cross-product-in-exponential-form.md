...
Source: https://proofwiki.org/wiki/Complex_Cross_Product_in_Exponential_Form
...
\(\ds \map \Im {r_1 e^{-i \theta_1} r_2 e^{i \theta_2} }\)
...
\(\ds \map \Im {r_1 r_2 e^{i \paren {\theta_2 - \theta_1} } }\)
...
\(\ds \map \Im {r_1 r_2 \paren {\map \cos {\theta_2 - \theta_1} + i \map \sin {\theta_2 - \theta_1} } }\)
...
\(\ds r_1 r_2 \map \sin {\theta_2 - \theta_1}\)
