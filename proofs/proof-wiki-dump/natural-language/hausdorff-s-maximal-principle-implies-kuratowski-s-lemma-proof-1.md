...
Source: https://proofwiki.org/wiki/Hausdorff%27s_Maximal_Principle_implies_Kuratowski%27s_Lemma/Proof_1
...
Sources
2010: Raymond M. Smullyan and Melvin Fitting: Set Theory and the Continuum Problem (revised ed.) ... (previous) ... (next): Chapter $4$: Superinduction, Well Ordering and Choice: Part $\text {II}$ -- Maximal principles: $\S 5$ Maximal principles: Proposition $5.10$
