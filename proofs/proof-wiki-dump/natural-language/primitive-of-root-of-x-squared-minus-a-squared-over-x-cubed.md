...
Source: https://proofwiki.org/wiki/Primitive_of_Root_of_x_squared_minus_a_squared_over_x_cubed
...
\(\ds \frac {-\sqrt {x^2 - a^2} } {2 x^2} + \frac 1 2 \paren {\frac 1 a \arcsec \size {\frac x a} } + C\)
...
\(\ds \frac {-\sqrt {x^2 - a^2} } {2 x^2} + \frac 1 {2 a} \arcsec \size {\frac x a} + C\)
