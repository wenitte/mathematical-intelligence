...
Source: https://proofwiki.org/wiki/Primitive_of_x_by_Root_of_x_squared_minus_a_squared_cubed
...
\(\ds \int x \paren {\sqrt {x^2 - a^2} }^3 \rd x\)
...
\(\ds \frac {\paren {\sqrt {x^2 - a^2} }^5} 5 + C\)
