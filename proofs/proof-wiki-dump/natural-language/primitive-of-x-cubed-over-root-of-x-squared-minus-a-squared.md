...
Source: https://proofwiki.org/wiki/Primitive_of_x_cubed_over_Root_of_x_squared_minus_a_squared
...
Sources
1968: Murray R. Spiegel: Mathematical Handbook of Formulas and Tables ... (previous) ... (next): $\S 14$: Integrals involving $\sqrt {x^2 - a^2}$: $14.212$
