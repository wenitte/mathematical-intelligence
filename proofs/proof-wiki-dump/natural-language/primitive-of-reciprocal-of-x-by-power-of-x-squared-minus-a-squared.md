...
Source: https://proofwiki.org/wiki/Primitive_of_Reciprocal_of_x_by_Power_of_x_squared_minus_a_squared
...
Also see
Primitive of $\dfrac 1 {x \paren {a^2 - x^2}^n}$


Sources
1968: Murray R. Spiegel: Mathematical Handbook of Formulas and Tables ... (previous) ... (next): $\S 14$: Integrals involving $x^2 - a^2$, $x^2 > a^2$: $14.160$
