...
Source: https://proofwiki.org/wiki/Real_Function_with_Negative_Derivative_is_Decreasing
...
$\map f d \le \map f c$
Thus $f$ is decreasing on $\closedint a b$.
$\blacksquare$


Sources
1977: K.G. Binmore: Mathematical Analysis: A Straightforward Approach ... (previous) ... (next): $\S 12.7 \ \text {(ii)}$
