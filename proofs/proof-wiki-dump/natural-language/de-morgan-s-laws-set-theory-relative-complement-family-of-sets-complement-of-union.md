...
Source: https://proofwiki.org/wiki/De_Morgan%27s_Laws_(Set_Theory)/Relative_Complement/Family_of_Sets/Complement_of_Union
...
\(\ds \relcomp S {\bigcup_{i \mathop \in I} S_i}\)
...
\(\ds S \setminus \paren {\bigcup_{i \mathop \in I} S_i}\)
...
\(\ds \bigcap_{i \mathop \in I} \paren {S \setminus S_i}\)
...
\(\ds \bigcap_{i \mathop \in I} \relcomp S {S_i}\)
