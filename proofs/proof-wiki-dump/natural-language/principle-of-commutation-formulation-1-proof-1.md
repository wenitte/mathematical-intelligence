...
Source: https://proofwiki.org/wiki/Principle_of_Commutation/Formulation_1/Proof_1



Theorem
$p \implies \left({q \implies r}\right) \dashv \vdash q \implies \left({p \implies r}\right)$
