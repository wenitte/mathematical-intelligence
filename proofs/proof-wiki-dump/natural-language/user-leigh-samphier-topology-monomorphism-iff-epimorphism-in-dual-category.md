...
Source: https://proofwiki.org/wiki/User:Leigh.Samphier/Topology/Monomorphism_iff_Epimorphism_in_Dual_Category
...
Then $f$ is a monomorphism in $\mathbf C$ if and only if $f^{\operatorname{op}}$ is a epimorphism in $\mathbf C^{\operatorname{op}}$.
