...
Source: https://proofwiki.org/wiki/Primitive_of_Reciprocal_of_x_cubed_by_Root_of_x_squared_plus_a_squared
...
\(\ds \frac {-\sqrt {z + a^2} } {2 \paren {2 - 1} a^2 z^{2 - 1} } - \frac {2 \paren 2 - 3} {2 \paren {2 \paren 2 - 2} a^2} \int \frac {\d z} {z^{2 - 1} \sqrt {z + a^2} } + C\)
...
\(\ds \frac {-\sqrt {x^2 + a^2} } {2 a^2 x^2} + \frac 1 {2 a^3} \map \ln {\frac {a + \sqrt {x^2 + a^2} } x} + C\)
