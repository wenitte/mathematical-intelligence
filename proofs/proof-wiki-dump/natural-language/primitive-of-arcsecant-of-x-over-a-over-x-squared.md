...
Source: https://proofwiki.org/wiki/Primitive_of_Arcsecant_of_x_over_a_over_x_squared
...
\(\ds \int \dfrac 1 {x^2} \arcsec \frac x a\)
...
\(\ds \frac {-1} x \arcsec \frac x a - \int \frac {-1} x \paren {\frac a {x \sqrt {x^2 - a^2} } } \rd x + C\)
...
\(\ds -\dfrac 1 x \arcsec \dfrac x a + a \int \frac {\d x} {x \sqrt {x^2 - a^2} } + C\)
...
\(\ds -\dfrac 1 x \arcsec \dfrac x a + a \paren {\frac {\sqrt {x^2 - a^2} } {a^2 x} } + C\)
...
\(\ds -\dfrac 1 x \arcsec \dfrac x a + \frac {\sqrt {x^2 - a^2} } {a x} + C\)
...
Sources
1968: Murray R. Spiegel: Mathematical Handbook of Formulas and Tables ... (previous) ... (next): $\S 14$: Integrals involving Inverse Trigonometric Functions: $14.497$
