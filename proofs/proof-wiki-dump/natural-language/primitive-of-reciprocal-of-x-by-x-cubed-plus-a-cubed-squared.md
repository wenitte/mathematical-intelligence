...
Source: https://proofwiki.org/wiki/Primitive_of_Reciprocal_of_x_by_x_cubed_plus_a_cubed_squared
...
Primitive of $\dfrac 1 {x \paren {x^3 + a^3} }$
...
Primitive of $\dfrac {x^2} {\paren {x^3 + a^3}^2}$
