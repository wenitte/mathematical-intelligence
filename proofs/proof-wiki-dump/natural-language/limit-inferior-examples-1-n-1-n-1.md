...
Source: https://proofwiki.org/wiki/Limit_Inferior/Examples/(-1)%5En_(1_%2B_n%5E-1)
...
Sources
1977: K.G. Binmore: Mathematical Analysis: A Straightforward Approach ... (previous) ... (next): $\S 5$: Subsequences: Lim sup and lim inf: Exercise $\S 5.15 \ (1) \ \text {(ii)}$
