...
Source: https://proofwiki.org/wiki/Pointwise_Addition_on_Differentiable_Real_Functions_on_Closed_Unit_Interval_forms_Group
...
From the Sum Rule for Derivatives, if $f$ and $g$ are differentiable real functions then so is $f + g$.
...
From Derivative of Constant $f_0$ is differentiable.
Hence $f_0 \in \mathscr D$.
$\Box$


Group Axiom $\text G 3$: Existence of Inverse Element
From the Derivative of Constant Multiple, if $\map f x$ is continuous then so is $\map g x$ where:
