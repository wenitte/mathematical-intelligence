...
Source: https://proofwiki.org/wiki/Primitive_of_Reciprocal_of_Cosine_of_a_x_by_1_plus_Sine_of_a_x
...
\(\ds \frac {-1} {2 a \paren {1 + \sin a x} } - \frac 1 {4 a} \ln \size {\frac {\map {\cos^2} {\frac \pi 4 + \frac {a x} 2} } {\map {\sin^2} {\frac \pi 2 - \paren {\frac \pi 4 - \frac {a x} 2} } } } + C\)
...
\(\ds \frac {-1} {2 a \paren {1 + \sin a x} } - \frac 1 {4 a} \ln \size {\frac {\map {\cos^2} {\frac \pi 4 + \frac {a x} 2} } {\map {\sin^2} {\frac \pi 4 + \frac {a x} 2} } } + C\)
