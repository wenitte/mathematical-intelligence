...
Source: https://proofwiki.org/wiki/Lexicographic_Order/Examples/Unit_Square_with_Open_Side
...
Proof
Recall the definition of the lexicographic order:

$\tuple {a, b} \preccurlyeq_l \tuple {c, d} \iff \tuple {a \prec_1 b} \lor \paren {a = b \land c \preccurlyeq_2 d}$
...
$\tuple {0, b} \preccurlyeq_l \tuple {a, b}$ but $\tuple {0, b} \ne \tuple {a, b}$
Similarly, suppose $b \ne 0$.
Then:

$\tuple {a, 0} \preccurlyeq_l \tuple {a, b}$ but $\tuple {a, 0} \ne \tuple {a, b}$
...
$\forall \tuple {c, d} \in T: \tuple {0, 0} \preccurlyeq_l \tuple {c, d}$
...
$\tuple {u, v} \preccurlyeq_l \tuple {x, y} \implies \tuple {u, v} = \tuple {x, y}$
and in particular:

$\tuple {u, v} \preccurlyeq_l \tuple {x, v} \implies \tuple {u, v} = \tuple {x, v}$
That is:
