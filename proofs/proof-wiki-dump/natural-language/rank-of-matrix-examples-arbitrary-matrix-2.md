...
Source: https://proofwiki.org/wiki/Rank_of_Matrix/Examples/Arbitrary_Matrix_2
...
Sources
1998: Richard Kaye and Robert Wilson: Linear Algebra ... (previous) ... (next): Part $\text I$: Matrices and vector spaces: $1$ Matrices: $1.5$ Row and column operations: Exercise $1.5 \ \text {(b)}$
