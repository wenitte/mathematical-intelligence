...
Source: https://proofwiki.org/wiki/Product_Inverse_Operation_Properties/Lemma_2
...
\(\ds \paren {x \oplus z} \circ \paren {z \oplus y}\)
...
\(\ds \paren {x \oplus z} \oplus \paren {e \oplus \paren {z \oplus y} }\)
