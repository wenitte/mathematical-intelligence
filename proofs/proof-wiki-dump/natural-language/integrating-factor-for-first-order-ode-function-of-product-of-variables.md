...
Source: https://proofwiki.org/wiki/Integrating_Factor_for_First_Order_ODE/Function_of_Product_of_Variables
...
Sources
1972: George F. Simmons: Differential Equations ... (previous) ... (next): $\S 2.9$: Integrating Factors: Problem $1$
