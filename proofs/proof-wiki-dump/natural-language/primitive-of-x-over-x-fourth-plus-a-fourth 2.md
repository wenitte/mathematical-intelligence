...
Source: https://proofwiki.org/wiki/Primitive_of_x_over_x_fourth_plus_a_fourth
...
\(\ds \int \frac {\d z} {2 \paren {z^2 + \paren {a^2}^2} }\)
...
\(\ds \frac 1 {2 a^2} \arctan \frac z {a^2} + C\)
...
\(\ds \frac 1 {2 a^2} \arctan \frac {x^2} {a^2} + C\)
