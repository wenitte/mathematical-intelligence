...
Source: https://proofwiki.org/wiki/Characterization_of_Generalized_Hilbert_Sequence_Space
...
Let $\set{j_0, j_1, j_2, \ldots}$ be a countably infinite subset of $I$ such that $\forall k \in \closedint 1 m$:
