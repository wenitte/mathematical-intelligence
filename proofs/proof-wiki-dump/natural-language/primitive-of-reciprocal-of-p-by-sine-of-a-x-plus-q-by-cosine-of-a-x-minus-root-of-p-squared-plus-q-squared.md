...
Source: https://proofwiki.org/wiki/Primitive_of_Reciprocal_of_p_by_Sine_of_a_x_plus_q_by_Cosine_of_a_x_minus_Root_of_p_squared_plus_q_squared
...
\(\ds \dfrac 1 {\sqrt {p^2 + q^2} } \int \frac {\d x} {-\map \cos {\pi - \paren {\frac \pi 2 - a x - \theta'} } - 1}\)
...
Definition of Real Secant Function and simplifying
