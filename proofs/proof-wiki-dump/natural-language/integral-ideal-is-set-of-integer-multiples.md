...
Source: https://proofwiki.org/wiki/Integral_Ideal_is_Set_of_Integer_Multiples

Theorem
Let $J$ be an integral ideal.
Then $J$ is in the form of a set of integer multiples $m \Z$ for some $m \in \Z$.
...
Sources
1971: George E. Andrews: Number Theory ... (previous) ... (next): $\text {2-1}$ Euclid's Division Lemma: Exercise $5$
