...
Source: https://proofwiki.org/wiki/Prosthaphaeresis_Formulas/Hyperbolic_Sine_minus_Hyperbolic_Sine
...
\(\ds 2 \map \cosh {\frac {x + y} 2} \map \sinh {\frac {x - y} 2}\)
...
\(\ds 2 \frac {\map \sinh {\dfrac {x - y} 2 + \dfrac {x + y} 2} + \map \sinh {\dfrac {x - y} 2 - \dfrac {x + y} 2} } 2\)
...
\(\ds \sinh \frac {2 x} 2 + \map \sinh {-\frac {2 y} 2}\)
...
\(\ds \sinh \frac {2 x} 2 - \sinh \frac {2 y} 2\)
