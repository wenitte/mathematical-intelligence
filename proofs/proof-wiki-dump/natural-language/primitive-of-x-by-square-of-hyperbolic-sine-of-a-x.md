...
Source: https://proofwiki.org/wiki/Primitive_of_x_by_Square_of_Hyperbolic_Sine_of_a_x
...
\(\ds \dfrac {x \sinh 2 a x} {4 a} - \frac {\cosh 2 a x} {8 a^2} - \frac {x^2} 4 + C\)
