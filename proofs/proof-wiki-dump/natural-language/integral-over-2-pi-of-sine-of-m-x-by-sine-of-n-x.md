...
Source: https://proofwiki.org/wiki/Integral_over_2_pi_of_Sine_of_m_x_by_Sine_of_n_x
...
\(\ds \int_\alpha^{\alpha + 2 \pi} \sin m x \sin n x \rd x\)
...
\(\ds \int_\alpha^{\alpha + 2 \pi} \sin m x \sin m x \rd x\)
...
\(\ds \paren {\frac {\alpha + 2 \pi} 2 - \frac {\sin \paren {2 m \paren {\alpha + 2 \pi} } } {4 m} } - \paren {\frac \alpha 2 - \frac {\sin 2 m \alpha} {4 m} }\)
