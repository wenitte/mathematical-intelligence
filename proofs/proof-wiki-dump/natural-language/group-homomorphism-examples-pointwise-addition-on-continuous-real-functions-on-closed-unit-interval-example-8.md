...
Source: https://proofwiki.org/wiki/Group_Homomorphism/Examples/Pointwise_Addition_on_Continuous_Real_Functions_on_Closed_Unit_Interval/Example_8
...
\(\ds \int_0^1 \int_0^1 \map {\paren {f + g} } {x y} \rd y \rd x\)
...
\(\ds \int_0^1 \int_0^1 \paren {\map f {x y} + \map g {x y} } \rd y \rd x\)
...
\(\ds \int_0^1 \int_0^1 \map f {x y} \rd y \rd x + \int_0^1 \int_0^1 \map g {x y} \rd y \rd x\)
