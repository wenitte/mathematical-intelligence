...
Source: https://proofwiki.org/wiki/Primitive_of_Root_of_x_squared_minus_a_squared_cubed_over_x_cubed
...
\(\ds \frac {-\paren {\sqrt {x^2 - a^2} }^3} {2 x^2} + \frac 3 2 \paren {\sqrt {x^2 - a^2} - a \arcsec \size {\frac x a} } + C\)
...
\(\ds \frac {-\paren {\sqrt {x^2 - a^2} }^3} {2 x^2} + \frac {3 \sqrt {x^2 - a^2} } 2 - \frac {3 a} 2 \arcsec \size {\frac x a} + C\)
...
Sources
1968: Murray R. Spiegel: Mathematical Handbook of Formulas and Tables ... (previous) ... (next): $\S 14$: Integrals involving $\sqrt {x^2 - a^2}$: $14.236$
