...
Source: https://proofwiki.org/wiki/Primitive_of_Logarithm_of_x_squared_minus_a_squared
...
\(\ds x \map \ln {x^2 - a^2} - 2 \paren {x + \frac a 2 \map \ln {\frac {x - a} {x + a} } } + C\)
...
\(\ds x \map \ln {x^2 - a^2} - 2 x - a \map \ln {\frac {x + a} {x - a} } + C\)
