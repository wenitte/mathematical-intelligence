...
Source: https://proofwiki.org/wiki/Minimally_Inductive_Class_under_Progressing_Mapping_is_Well-Ordered_under_Subset_Relation/Proof_1
...
Sources
2010: Raymond M. Smullyan and Melvin Fitting: Set Theory and the Continuum Problem (revised ed.) ... (previous) ... (next): Chapter $3$: The Natural Numbers: $\S 4$ A double induction principle and its applications: Theorem $4.16$
