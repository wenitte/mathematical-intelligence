...
Source: https://proofwiki.org/wiki/Primitive_of_Power_of_x_by_Arccosine_of_a_x
...
\(\ds \frac {x^{n + 1} } {n + 1} \arccos x + \frac 1 {n + 1} \int \frac {x^{n + 1} \rd x} {\sqrt {1 - x^2} }\)





Primitive of $x^n \arccos x$
...
\(\ds \int \dfrac 1 {a^n} \paren {a x}^n \arccos a x \rd x\)
...
\(\ds \dfrac 1 {a^n} \int \paren {a x}^n \arccos a x \rd x\)
...
\(\ds \dfrac 1 {a^n} \paren {\dfrac 1 a \paren {\frac 1 {n + 1} \paren {a x}^{n + 1} \arccos a x + \frac 1 {n + 1} \int \paren {a x}^{n + 1} \frac {\d x} {\sqrt {1 - \paren {a x}^2} } } }\)
...
\(\ds \frac {x^{n + 1} } {n + 1} \arccos a x + \frac a {n + 1} \int \frac {x^{n + 1} \rd x} {\sqrt {1 - a^2 x^2} }\)
