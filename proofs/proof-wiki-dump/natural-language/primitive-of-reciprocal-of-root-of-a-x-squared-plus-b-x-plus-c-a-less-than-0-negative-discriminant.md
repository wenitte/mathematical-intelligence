...
Source: https://proofwiki.org/wiki/Primitive_of_Reciprocal_of_Root_of_a_x_squared_plus_b_x_plus_c/a_less_than_0/Negative_Discriminant
...
$\ds \int \frac {\d x} {\sqrt {a x^2 + b x + c} } = \frac {-1} {\sqrt {-a} } \map \arcsin {\frac {2 a x + b} {\sqrt {4 a c - b^2} } } + C$
