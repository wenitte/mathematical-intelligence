...
Source: https://proofwiki.org/wiki/Primitive_of_Reciprocal_of_x_cubed_by_x_fourth_minus_a_fourth
...
\(\ds \int \frac {\paren {x^4 - \paren {x^4 - a^4} } \rd x} {a^4 x^3 \paren {x^4 - a^4} }\)
...
\(\ds \frac 1 {2 a^4 x^2} + \frac 1 {a^4} \paren {\frac 1 {4 a^2} \ln \size {\frac {x^2 - a^2} {x^2 + a^2} } } + C\)
...
\(\ds \frac 1 {2 a^4 x^2} + \frac 1 {4 a^6} \ln \size {\frac {x^2 - a^2} {x^2 + a^2} } + C\)
