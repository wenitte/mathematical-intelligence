...
Source: https://proofwiki.org/wiki/Primitive_of_Reciprocal_of_x_squared_by_x_squared_plus_a_squared/Partial_Fraction_Expansion

Lemma for Primitive of Reciprocal of $x^2 \paren {x^2 + a^2}$
$\dfrac 1 {x^2 \paren {x^2 + a^2} } \equiv \dfrac 1 {a^2 x^2} - \dfrac 1 {a^2 \paren {x^2 + a^2} }$
