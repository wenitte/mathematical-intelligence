...
Source: https://proofwiki.org/wiki/Power_Structure_Operation_on_Set_of_Singleton_Subsets_preserves_Associativity
...
Then $\circ_\PP$ is associative if and only if $\circ$ is associative.
...
The result follows from Isomorphism Preserves Associativity.
$\blacksquare$
