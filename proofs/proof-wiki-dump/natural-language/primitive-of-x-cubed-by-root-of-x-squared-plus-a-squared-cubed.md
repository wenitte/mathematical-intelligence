...
Source: https://proofwiki.org/wiki/Primitive_of_x_cubed_by_Root_of_x_squared_plus_a_squared_cubed
...
Sources
1968: Murray R. Spiegel: Mathematical Handbook of Formulas and Tables ... (previous) ... (next): $\S 14$: Integrals involving $\sqrt {x^2 + a^2}$: $14.206$
