...
Source: https://proofwiki.org/wiki/Primitive_of_Reciprocal_of_1_minus_Sine_of_a_x/Corollary_1
...
\(\ds \map \tan {\frac \pi 4 + \frac x 2} + C\)
...
\(\ds \map \tan {\frac x 2 + \frac \pi 4} + C\)
