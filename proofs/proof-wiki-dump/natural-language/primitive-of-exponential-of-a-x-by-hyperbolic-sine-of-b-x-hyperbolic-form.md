...
Source: https://proofwiki.org/wiki/Primitive_of_Exponential_of_a_x_by_Hyperbolic_Sine_of_b_x/Hyperbolic_Form
...
Primitive of $e^{a x} \sinh b x$: Exponential Form
...
\(\ds \frac {e^{a x} } 2 \paren {\frac {e^{b x} \paren {a - b} - e^{-b x} \paren {a + b} } {a^2 - b^2} } + C\)
...
\(\ds \frac {e^{a x} } {a^2 - b^2} \paren {a \frac {e^b x - e^{-b} x} 2 - b \cosh b x} + C\)
...
\(\ds \frac {e^{a x} } {a^2 - b^2} \paren {a \sinh b x - b \cosh b x} + C\)
...
\(\ds \frac {e^{a x} \paren {a \sinh b x - b \cosh b x} } {a^2 - b^2} + C\)
