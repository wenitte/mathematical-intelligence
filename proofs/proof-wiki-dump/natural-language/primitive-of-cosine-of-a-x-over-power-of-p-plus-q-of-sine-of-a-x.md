...
Source: https://proofwiki.org/wiki/Primitive_of_Cosine_of_a_x_over_Power_of_p_plus_q_of_Sine_of_a_x
...
\(\ds \int \frac {\cos a x \rd x} {\paren {p + q \sin a x}^n}\)
...
\(\ds \frac {-1} {a q \paren {n - 1} \paren {p + q \sin a x}^{n - 1} } + C\)
