...
Source: https://proofwiki.org/wiki/Primitive_of_Arcsecant_of_x_over_a/Formulation_1
...
\(\ds x \arcsec \frac x a - \int x \paren {\frac a {x \sqrt {x^2 - a^2} } } \rd x + C\)
...
\(\ds x \arcsec \frac x a - a \int \frac {\d x} {\sqrt {x^2 - a^2} } + C\)
...
\(\ds x \arcsec \frac x a - a \map \ln {x + \sqrt {x^2 - a^2} } + C\)
