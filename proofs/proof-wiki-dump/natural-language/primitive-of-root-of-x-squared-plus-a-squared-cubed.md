...
Source: https://proofwiki.org/wiki/Primitive_of_Root_of_x_squared_plus_a_squared_cubed
...
\(\ds \frac {\sqrt z \paren {\sqrt {z + a^2} }^3} 4 + \frac {3 a^2} 8 \paren {\sqrt z \sqrt {z + a^2} + \frac {a^2} 2 \int \frac {\d z} {\sqrt z \sqrt {z + a^2} } } + C\)
...
\(\ds \frac {x \paren {\sqrt {x^2 + a^2} }^3} 4 + \frac {3 a^2 x \sqrt {x^2 + a^2} } 8 + \frac {3 a^4} 8 \map \ln {x + \sqrt {x^2 + a^2} } + C\)
...
Sources
1968: Murray R. Spiegel: Mathematical Handbook of Formulas and Tables ... (previous) ... (next): $\S 14$: Integrals involving $\sqrt {x^2 + a^2}$: $14.203$
