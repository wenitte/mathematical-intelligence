...
Source: https://proofwiki.org/wiki/Definite_Integral_to_Infinity_of_Cosine_of_a_x%5E2
...
\(\ds \int_0^\infty \map \cos {a x^2} \rd x\)
...
\(\ds \int_0^\infty \map \Re {\map \exp {-i a x^2} \rd x}\)
...
\(\ds \map \Re {\int_0^\infty \map \exp {-i a x^2} \rd x}\)
...
\(\ds \frac 1 {\sqrt a} \map \Re {\int_0^\infty \map \exp {-i t^2} \rd t}\)
...
\(\ds \frac 1 {\sqrt a} \map \Re {\frac 1 2 \sqrt {\frac \pi 2} \paren {1 - i} }\)
