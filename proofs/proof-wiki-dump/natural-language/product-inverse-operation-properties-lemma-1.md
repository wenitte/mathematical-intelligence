...
Source: https://proofwiki.org/wiki/Product_Inverse_Operation_Properties/Lemma_1
...
\(\ds \paren {x \circ z} \oplus \paren {y \circ z}\)
...
\(\ds \paren {x \oplus \paren {e \oplus z} } \oplus \paren {y \oplus \paren {e \oplus z} }\)
