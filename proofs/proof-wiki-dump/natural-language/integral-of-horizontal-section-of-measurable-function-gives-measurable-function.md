...
Source: https://proofwiki.org/wiki/Integral_of_Horizontal_Section_of_Measurable_Function_gives_Measurable_Function
...
\(\ds \int \paren {\sum_{k \mathop = 1}^n a_k \chi_{\paren {E_k}^y} } \rd \mu\)
...
\(\ds \sum_{k \mathop = 1}^n \int \paren {a_k \chi_{\paren {E_k}^y} } \rd \mu\)
...
\(\ds \sum_{k \mathop = 1}^n a_k \paren {\int \chi_{\paren {E_k}^y} \rd \mu}\)
...
\(\ds \sum_{k \mathop = 1}^n a_k \map {\mu} {\paren {E_k}^y}\)
