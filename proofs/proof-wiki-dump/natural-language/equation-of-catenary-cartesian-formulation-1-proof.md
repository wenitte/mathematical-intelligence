...
Source: https://proofwiki.org/wiki/Equation_of_Catenary/Cartesian/Formulation_1/Proof
...
This page has been identified as a candidate for refactoring of basic complexity.In particular: Rather than repeat the argument, start here with the Whewell Equation for Catenary and save this bit of work.Until this has been finished, please leave {{Refactor}} in the code.
...
Sources
1972: George F. Simmons: Differential Equations ... (previous) ... (next): $\S 2.12$: The Hanging Chain. Pursuit Curves: Example $(1)$
1992: George F. Simmons: Calculus Gems ... (previous) ... (next): Chapter $\text {B}.11$: The Catenary, or Curve of a Hanging Chain
