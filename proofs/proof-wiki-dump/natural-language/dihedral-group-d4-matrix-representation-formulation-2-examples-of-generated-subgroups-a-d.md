...
Source: https://proofwiki.org/wiki/Dihedral_Group_D4/Matrix_Representation/Formulation_2/Examples_of_Generated_Subgroups/A,_D
...
Thus for a start $\mathbf I, \mathbf A, \mathbf B, \mathbf C \in \gen {\mathbf A, \mathbf D}$.
...
and so it follows that $\gen {\mathbf A, \mathbf D} = D_4$.
$\blacksquare$
