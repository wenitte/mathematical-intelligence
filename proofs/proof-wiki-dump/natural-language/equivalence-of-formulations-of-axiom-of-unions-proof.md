...
Source: https://proofwiki.org/wiki/Equivalence_of_Formulations_of_Axiom_of_Unions/Proof
...
Sources
2010: Raymond M. Smullyan and Melvin Fitting: Set Theory and the Continuum Problem (revised ed.) ... (previous) ... (next): Chapter $2$: Some Basics of Class-Set Theory: $\S 5$ The union axiom: Exercise $5.1$
