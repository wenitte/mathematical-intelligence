...
Source: https://proofwiki.org/wiki/Divisor_of_Integer/Examples/6_divides_n_(n%2B1)_(n%2B2)/Proof_2
...
Sources
1953: L. Harwood Clarke: A Note Book in Pure Mathematics ... (previous) ... (next): $\text I$. Algebra: The Method of Induction: Exercises $\text {II}$: $8$
