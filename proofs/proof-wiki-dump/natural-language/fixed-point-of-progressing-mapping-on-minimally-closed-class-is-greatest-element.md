...
Source: https://proofwiki.org/wiki/Fixed_Point_of_Progressing_Mapping_on_Minimally_Closed_Class_is_Greatest_Element
...
Sources
2010: Raymond M. Smullyan and Melvin Fitting: Set Theory and the Continuum Problem (revised ed.) ... (previous) ... (next): Chapter $3$: The Natural Numbers: $\S 4$ A double induction principle and its applications: Theorem $4.17 \ (3)$
